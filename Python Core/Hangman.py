...
def game():
    ...
    while attempts > 0:
        ...
        if guess in word_to_guess:
            # checking if multiple letters needs to be swaped
...
def get_input(guessing_word):
    while True:
        ...
        if len(letter) != 1:
            ...
            # case for when letter isn't a lower case letter or a ASCI symbol
